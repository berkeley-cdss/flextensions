...
RSpec.describe Course, type: :model do
  ...
  describe '.sync_assignment' do
    ...
    it 'creates or updates an assignment' do
      canvas_assignment = LMS::Canvas::Assignment.new({ 'id' => 'a123', 'name' => 'HW1', 'due_at' => 1.day.from_now.to_s })
      expect do
  ...
  describe '.sync_assignments' do
    ...
    it 'calls sync_assignment for each assignment and deletes missing ones' do
      ...
      canvas_assignment = LMS::Canvas::Assignment.new({ 'id' => 'new1', 'name' => 'New Assignment', 'due_at' => nil })
